...
title Project Kizen Optimizer v1.3.0
color 0A
...
cls
echo =======================================================================
echo          PROJECT KIZEN OPTIMIZER - SYSTEM MAINTENANCE MENU (v1.3.0)
echo =======================================================================
